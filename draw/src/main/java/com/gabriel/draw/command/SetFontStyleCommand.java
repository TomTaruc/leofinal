...
public class SetFontStyleCommand implements Command {
    ...
    public SetFontStyleCommand(AppService appService, int oldValue, int newValue, Font oldFont) {
    ...
    @Override
    public void execute() {
        appService.setFontStyle(newValue);
    }
    ...
    public void undo() {
        ...
        appService.setFontStyle(oldValue); // trigger repaint
    }
